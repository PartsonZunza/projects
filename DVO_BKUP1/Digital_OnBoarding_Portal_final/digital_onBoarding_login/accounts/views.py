...
def update_product(request):
    if request.method == 'GET':
        ...
        product_terms = request.GET.get('product_terms')
        product_conditions = request.GET.get('product_conditions')
        product_requirements = request.GET.get('product_requirements')
        product_code = request.GET.get('product_code')
        product_currency = request.GET.get('product_currency')
        ...
        print("This is where l print my description")

        print("This is where l print my description")
        print("==================form================", product_name)
        print("==================form================", product_description)
        print("==================form================", product_image)
        print("==================form================", product_terms)
        print("==================form================", product_conditions)
        print("==================form================", product_requirements)
        print("==================form================", product_code)
        print("==================form================", product_currency)

        context = {'product_name': product_name, 'product_description': product_description,
                   'product_image': product_image, 'product_terms': product_terms,
